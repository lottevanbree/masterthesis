...
const nonPersonalizedPlaylists = playlistTitles.filter((playlist, index) => {
if (index % 2 === 0) {
playlist[0] = genre + " Playlist";
playlist[2] = "More " + genre + " Music";
return true;
}
return false;
}).flat();

const personalizedPlaylists = playlistTitles.filter((playlist, index) => {
if (index % 2 !== 0) {
playlist[0] = "Your " + genre + " Playlist";
playlist[2] = genre + " for you";
return true;
}
return false;
}).flat();
...
titles[0].textContent = personalizedPlaylists[0];
titles[1].textContent = nonPersonalizedPlaylists[0];
titles[2].textContent = personalizedPlaylists[2];
titles[3].textContent = nonPersonalizedPlaylists[2];
